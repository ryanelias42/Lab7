...
public class PatientTests {
	...
	//(4) p is HealthyPerson (expect 0)
		Assert.assertEquals("compareToImpl incorrect, p = HealthyPerson issue", 0, sp1.compareToImpl(hp));
	}
	...
	public void SickPersontoStringTest() {
		//test toString
		Assert.assertEquals("toString incorrect", "Alex, a 20-year old. Severity level 10",sp1.toString());
	}
	...
	//(4) p is SickPerson (expect 0)
		Assert.assertEquals("HP compare incorrect, p = SickPerson.", 0,hp1.compareToImpl(sp),0.000001);
	}
	
	//test toString
	@Test
	public void HealthyPersontoStringTest() {
		Assert.assertEquals("HP toString incorrect.", "Alex, a 20-year old. In for allergies",hp1.toString());	
	}
	...
	public void PriorityNumTypeAddInfoTest() {
		...
		Assert.assertEquals("allPatientInfo incorrect for PriorityQueueHospital.", hp.toString() + sp.toString(), priority.allPatientInfo());
	...
	public void PriorityNextPatientTreatNextPatient() {
		...
		Assert.assertEquals("nextPatient incorrect for PriorityQueueHospital.", hp2, x);
		Assert.assertEquals("treatNextPatient incorrect for PriorityQueueHospital.", hp2, priority.treatNextPatient());
	}
